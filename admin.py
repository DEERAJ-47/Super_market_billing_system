...
class Inventory:
    def __init__(self, top=None):
        ...
        self.tree.heading("Manf_date", text="Manf_date", anchor=W)
        self.tree.heading("exp_date", text="exp_date", anchor=W)
