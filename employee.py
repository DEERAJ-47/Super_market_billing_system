...
class bill_window:
    ...
    def show_qty(self, Event):
        ...
        self.qty_labe2 = Label(biller)
        self.qty_labe2.place(relx=0.033, rely=0.700, width=82, height=26)
        self.qty_labe2.configure(font="-family {Poppins} -size 8")
        self.qty_labe2.configure(anchor="w")
        ...
        self.qty_label2.configure(text="Manf_Date: {}".format(results[0]))
        self.qty_label2.configure(background="#ffffff")
        self.qty_label2.configure(foreground="#333333")
